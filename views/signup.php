...
<main class="w-full min-h-screen mt-2">
  ...
  <form onsubmit="validate(signup); return false" enctype="multipart/form-data" class="flex flex-col px-4 lg:w-1/3 mx-auto gap-4 [&_input]:h-10 [&_input]:rounded-md [&_input]:outline-none [&_input]:text-black">
